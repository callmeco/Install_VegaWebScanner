...
echo -e "${blueText}Downloading Java JDK Version 8...${defaultText}"
sudo apt-get install openjdk-8-jdk
echo -e "${greenText}Successfully downloaded Java JDK Version 8"

# Switch JDK Version
echo -e "${blueText}Switching Java JDK Version to openjdk-8-jre . . .${defaultText}"
...
# Move folder vega and vega.zip to trash
echo -e "${blueText}Moving vega and vega.zip to trash. . .${defaultText}"
